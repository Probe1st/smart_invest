...
export default function WayWithUs() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center w-full h-[700px] bg-auto bg-top bg-no-repeat">
        {/* <div className="way">{dataForCard}</div> */}
        <img className="-z-50" src={process.env.PUBLIC_URL + "way.png"} alt="steps" />
      </div>
...
// url(https://firebasestorage.googleapis.com/v0/b/smart-invest-14838.appspot.com/o/png%2Fway.png?alt=media&token=690f8614-b736-4dd1-bd8e-4a739718bf4d)