...
function Replenish() {
  return (
    <div>
      <h2 className="justify-self-start text-2xl font-semibold">Пополнить баланс</h2>

      <p className="w-10/12 text-justify text-ellipsis ">
        Для получения информации об удобных вариантах оплаты обратитесь к вашему персональному менеджеру.
        Он предоставит вам индивидуальные реквизиты, и закрепит робота.
      </p>

      <Link to={"https://example.com"} target="_blank" className={"bg-blue-500 px-20 py-2 w-fit rounded-3xl text-2xl"}>Связаться</Link>
    </div>
  )
}